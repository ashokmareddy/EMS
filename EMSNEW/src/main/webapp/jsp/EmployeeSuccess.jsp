...
<body>
	...
	<div class="container">
		...
		<font><h1>Record Added Successfully!!</h1></font>

		<!-- <form method="GET" action="login"> -->
			<!-- <button type=button onclick="showLoginPage()">Login Page</button> -->
			
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Login</button>
<button onclick="backToAddEmployee()" style="width:auto;">Back</button>
		<!-- </form> -->
